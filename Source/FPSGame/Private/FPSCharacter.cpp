...
void AFPSCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Alt_Fire", IE_Pressed, this, &AFPSCharacter::Alt_Fire);
...
void AFPSCharacter::Alt_Fire()
{
	...
	if (ProjectileClass)
	{
		...
		// spawn the projectile at the muzzle
		GetWorld()->SpawnActor<AFPSProjectile>(Alt_FireProjectileClass, MuzzleLocation, MuzzleRotation, ActorSpawnParams);
	}
